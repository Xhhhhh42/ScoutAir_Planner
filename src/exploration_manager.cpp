    ...
    nh_private_(nh_private)
{
  ...
  initialize();
  ROS_INFO("Exploration Manager inited1");
}
...
// int ExplorationManager::planExploreMotion(
...
// void ExplorationManager::shortenPath(vector<Vector3d>& path) {
//   if (path.empty()) {
...
// void ExplorationManager::findGlobalTour(
